...
from loans.models import loanCategory, loanRequest, CustomerLoan, loanTransaction
            ...
            if form.is_valid():
                ...
                if user is not None:
                    if user.is_superuser:
                        ...
                        return render(request, 'admin/adminLogin.html', context={'form':form, 'error': "You are not Super Admin User."})
